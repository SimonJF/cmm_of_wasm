...
let suite =
  "cmm_of_wasm: Util.Type_hashing" >::: [
    "void -> void" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000000" in
    ...
    "void -> i32" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000001" in
    ...
    "void -> i64" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000002" in
    ...
    "void -> f32" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000003" in
    ...
    "void -> f64" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000004" in
    ...
    "i32 -> void" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000008" in
      let func_ty = FuncType ([I32Type], []) in
      let actual = Util.Type_hashing.hash_function_type func_ty in
      assert_nativeint_equal expected actual
    );
    ...
    "i32 -> i32" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000009" in
    ...
    "i32 -> i64" >:: (fun _ ->
      let expected = Nativeint.of_string "0x800000000000000A" in
    ...
    "i32, i64, f32, f64 -> i64" >:: (fun _ ->
      let expected = Nativeint.of_string "0x800000000000468A" in
    ...
    "i32, i32, f32 -> void" >:: (fun _ ->
      let expected = Nativeint.of_string "0x8000000000000648" in
